 ...
 * |--------------------------------|
 */
Route::prefix('centro-custo')->controller(CentroCustoController::class)->
 ...
 * |--------------------------------|
 */
Route::prefix('lancamento')->controller(LancamentoController::class)->
middleware('auth')->group(function(){
    Route::get('/','index')->name('lancamento.index');
    Route::get('/novo','create')->name('lancamento.create');
    Route::get('/editar/{id}')->name('lancamento.edit');
